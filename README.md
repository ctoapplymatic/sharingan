...
[![Version](https://img.shields.io/badge/version-0.3.0-blueviolet?style=for-the-badge)](https://github.com/shruthikj/sharingan-autotest/releases)
...
```bash
curl -fsSL https://raw.githubusercontent.com/shruthikj/sharingan-autotest/main/install.sh | bash
```
...
```bash
git clone https://github.com/shruthikj/sharingan-autotest
cd sharingan
