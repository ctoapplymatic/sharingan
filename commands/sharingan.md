...
If `~/.sharingan/scripts/` doesn't exist, tell the user to run `curl -fsSL https://raw.githubusercontent.com/shruthikj/sharingan-autotest/main/install.sh | bash` and stop.
